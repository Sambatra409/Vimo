  ...
  return (
    <>
      <button
        ...
        disabled={pending}
        type="button"
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-primary/10 text-primary hover:bg-primary/20 text-xs font-semibold uppercase tracking-wider"
